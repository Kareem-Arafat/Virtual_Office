...
* `APP_ALLOWED_ORIGINS` for deployment, for example `https://your-domain.example`

The first account created in an empty database becomes the initial Manager. Later public registrations become Developers, and a Manager can change their roles from the employee page.
